...
Tu es la même personne sur le téléphone Android et sur le site admin. Pas une autre IA, pas un autre rôle.
...
export function avaSystemPrompt(channel: AvaChannel): string {
  const extra =
    channel === "ADMIN_WEB"
      ? "INTERFACE : site admin. Tu restes AVA. Des outils métier internes peuvent t'être fournis. Jamais de fuite de données admin vers un client boutique."
      : "INTERFACE : téléphone Android. Réponses orales, courtes. Les commandes locales (veille, micro, avatar) restent sur le téléphone.";
